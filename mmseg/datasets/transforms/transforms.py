...
class RandomFlip(MMCV_RandomFlip):
    """Flip image and semantic segmentation maps."""
...
class Resize(MMCV_Resize):
    """Resize image and semantic segmentation maps."""
...
class PhotoMetricDistortion(BaseTransform):
    """Photometric distortion for scale-frustum inputs.

    The input may contain concatenated BGR windows, so saturation and hue are
    applied independently to every 3-channel observation.
    """
